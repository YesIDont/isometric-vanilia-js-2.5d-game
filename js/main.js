...
var map = new generateMap(
  16,    // horizontal number of tiles
  32,    // vertical number of tiles
  74,       // tile twidth
  40,       // tile heigh
...
player.collisionModel = new player.calcCollisionModel(map, player);
  ...
  var selectTool = new newUiItem("a", "", "button", "select-multiple", "#", "ico-select-multiple.svg", "ico-select-multiple-h.svg", false, false, selectTiles
      );

  var dragTiles = new newUiItem("a", "", "button", "select-tool", "#", "ico-select-tool.svg", "ico-select-tool-h.svg", false, false );

  var measurments = new newUiItem("a", "", "button", "measurments", "#devTools", "ico-measurments.svg", "ico-measurments-h.svg", true, true);
